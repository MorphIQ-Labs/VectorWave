package com.morphiqlabs.wavelet.extensions.util;

import com.morphiqlabs.wavelet.config.TransformConfig;
import com.morphiqlabs.wavelet.cwt.ComplexNumber;
import com.morphiqlabs.wavelet.util.ThreadLocalManager;
import com.morphiqlabs.wavelet.util.PowerOf2Utils;
 ...
 *   <li>Automatic scalar fallback for small signals (n {@literal <} 256) to avoid vectorization overhead</li>
 * </ul>
 * 
 * <p><strong>References:</strong></p>
 * <ul>
 *   <li>Cooley, J. W., {@literal &} Tukey, J. W. (1965). "An algorithm for the machine calculation 
...
public final class OptimizedFFT {
     ...
     * <p>The unpacking loop uses k {@literal <} halfN (not k {@literal <=} halfN) as the bound.
