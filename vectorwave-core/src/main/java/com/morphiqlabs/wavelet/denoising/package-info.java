 ...
 * <ul>
 *   <li>Compatible with all discrete wavelet types from {@link com.morphiqlabs.wavelet.api}</li>
 *   <li>Utilizes optimized transform implementations from {@link com.morphiqlabs.wavelet.WaveletTransform}</li>
 *   <li>Supports concurrent processing through {@link com.morphiqlabs.wavelet.concurrent}</li>
 *   <li>Memory-optimized implementations using {@link com.morphiqlabs.wavelet.memory} utilities</li>
 * </ul>
 * 
 ...
 * </ul>
 * 
 * @see com.morphiqlabs.wavelet.api.DiscreteWavelet
 * @see com.morphiqlabs.wavelet.WaveletTransform
 * @see com.morphiqlabs.wavelet.concurrent
 * @see com.morphiqlabs.wavelet.memory
 */
