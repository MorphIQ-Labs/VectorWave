...
import com.morphiqlabs.wavelet.util.CoreFFT;
...
public final class AdaptivePaddingStrategy implements PaddingStrategy {
    ...
    /**
     * Helper method to perform FFT on interleaved complex data.
     * Adapts CoreFFT API to work with OptimizedFFT's interleaved format.
     * 
     * @param interleavedData array containing interleaved real/imaginary parts [re, im, re, im, ...]
