 ...
 * 
 * <h3>{@link com.morphiqlabs.wavelet.streaming.StreamingDenoiserStrategy}</h3>
 ...
 * </ul>
 * 
 * <h3>{@link com.morphiqlabs.wavelet.streaming.StreamingDenoiserFactory}</h3>
 * <p>Factory for creating streaming denoisers with automatic implementation
 * selection based on configuration.</p>
 * 
 * <h3>{@link com.morphiqlabs.wavelet.streaming.StreamingDenoiserConfig}</h3>
