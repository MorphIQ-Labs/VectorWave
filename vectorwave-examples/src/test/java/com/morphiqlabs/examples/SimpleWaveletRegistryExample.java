...
/**
 * Simple example showing the most common Wavelet Registry usage patterns.
 * 
 * <p>This example demonstrates the essential patterns every developer should know:
 * <ul>
 *   <li>Checking wavelet availability</li>
 *   <li>Getting wavelets safely</li>
 *   <li>Using wavelets with MODWT</li>
 *   <li>Basic error handling</li>
 * </ul>
 * </p>
 * 
 * <p>For comprehensive examples and advanced usage, see {@link WaveletRegistryBestPracticesDemo}.</p>
 */
public class SimpleWaveletRegistryExample {
