...
public class BenchmarkRunner {
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        System.out.println("  Results: " + resultFile + ".[json|csv]");
        System.out.println();
        ...
        optBuilder.result(resultFile + ".json")
        ...
        System.out.println("  - " + resultFile + ".json");
        System.out.println();
        System.out.println("View results with:");
        System.out.println("  python3 scripts/analyze-benchmarks.py " + resultFile + ".json");
    }
