 ...
 * 
 * <p>Leverages Java 24's Vector API for significant performance improvements
...
public final class CWTVectorOps {
    ...
    // Heuristic thresholds derived from Vector API species length only (no internal detectors)
    ...
    private static final int SIMD_THRESHOLD = (SPECIES.length() >= 4) ? 256 : 512;
