package com.morphiqlabs.examples.cwt.optimization;
...
public final class ComplexVectorOps {
    ...
    // Static assertion to ensure UNROLL_FACTOR is set to 4.
    // Note: This does not validate that the unrolled code uses the same number of iterations.
    static {
        if (UNROLL_FACTOR != 4) {
     ...
     * improvement over naive element-by-element conversion through:</p>
     * <ul>
     ...
     * through the same optimization techniques as convertToSplit():</p>
     * <ul>
